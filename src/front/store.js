    ...
    content: {
      es: {
        profile: {
          ...
          skills: [
            "React.js", "Flask", "Python", "SQLAlchemy", "JavaScript", "HTML5", "CSS3", 
            "GitHub", "Git", "Bootstrap", "Jest", "Restful APIs", "JWT", "Excel", "PowerBI"
          ]
        },
        projects: [
          {
            ...
            description: "Plataforma web responsive para un refugio de animales. Incluye sistema de registro, perfiles de mascotas y panel administrativo.",
        ...
        ui: {
          nav: { skills: "Skills", projects: "Proyectos", experience: "Experiencia", contact: "Contacto" },
          hero: { greeting: "Hola, soy", downloadCv: "Descargar CV", contactMe: "Contactar" },
          sections: {
            skills: "Mis Habilidades",
            projects1: "Proyectos", projects2: "Destacados",
            liveProject: "Ver Proyecto en vivo",
            exp1: "Experiencia", exp2: "Profesional",
            edu: "Educación",
            contact1: "Ponte en", contact2: "Contacto",
          },
          contact: {
            title: "Hablemos de tu próximo proyecto",
            desc: "Estoy disponible para nuevos desafíos profesionales y oportunidades de colaboración.",
            emailLabel: "Email", locationLabel: "Ubicación",
            formName: "Nombre Completo", formNamePh: "Ej. Juan Pérez",
            formEmail: "Correo Electrónico", formEmailPh: "tucorreo@ejemplo.com",
            formMsg: "Mensaje", formMsgPh: "¿En qué puedo ayudarte?",
            sendBtn: "Enviar Mensaje", sendingBtn: "Enviando...",
            successTitle: "¡Mensaje Enviado!",
            successDesc: "Gracias por contactarme. Te responderé lo antes posible a",
      ...
      en: {
        profile: {
          ...
          github: "https://github.com/VeronikBW",
          linkedin: "https://www.linkedin.com/in/veronicarodriguez66/",
          about: "Full Stack Developer with experience in React, Flask, and SQLAlchemy. Previous background as Operations Manager, specialized in workflow optimization, data management, and team leadership. Focused on developing scalable solutions that ensure operational continuity and business efficiency.",
        ...
        projects: [
          {
            ...
            period: "2025",
            link: "https://sample-service-name-siok.onrender.com/",
            description: "Responsive web platform for an animal shelter. Includes registration system, pet profiles, and administrative dashboard.",
            image: "https://images.unsplash.com/photo-1450778869180-41d0601e046e?auto=format&fit=crop&q=80&w=800",
        ...
        ui: {
          nav: { skills: "Skills", projects: "Projects", experience: "Experience", contact: "Contact" },
          hero: { greeting: "Hi, I'm", downloadCv: "Download CV", contactMe: "Contact Me" },
          sections: {
            skills: "My Skills",
            projects1: "Featured", projects2: "Projects",
            liveProject: "View Live Project",
            exp1: "Professional", exp2: "Experience",
            edu: "Education",
            contact1: "Get in", contact2: "Touch",
          },
          contact: {
            ...
            formName: "Full Name", formNamePh: "e.g. John Doe",
            formEmail: "Email Address", formEmailPh: "yourmail@example.com",
            formMsg: "Message", formMsgPh: "How can I help you?",
            sendBtn: "Send Message", sendingBtn: "Sending...",
            successTitle: "Message Sent!",
            successDesc: "Thanks for reaching out. I'll get back to you soon at",
